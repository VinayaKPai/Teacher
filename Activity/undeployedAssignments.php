<?php
	...
	$curdate = date("Y-m-d");
	$slno = 0;
	$query = $mysqli->query("SELECT * FROM deploymentlog, assessments WHERE deploymentlog.depType = 'A' AND  deploymentlog.deploySuccess = 0 AND assessments.assessment_Id = deploymentlog.dep_assessmentId");
