CREATE DATABASE teachers_tool;
//updates assessments, assessment_questions, deploymentlog on 13 aug 2020 
...
CREATE TABLE `assessments` (
  ...
  CONSTRAINT `FK_a_subjects` FOREIGN KEY (`subjectId`) REFERENCES `subjects` (`subjectId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
--

INSERT INTO `assessments` (`assessment_Id`, `assessment_Title`, `assessment_questions`, `subjectId`) VALUES
  (1, 'My First assessment', '7,8,9','4'),
  (2, 'Ass 2', '3,4','5'),
  (3, 'Chapter and Verse', '11,13,16','4'),
  (4, 'Dumb and Dumber', '481,482,483,484','2'),
  (5, 'Just 3 questions', '481,482,483','2'),
  (6, 'Eng act 5', '490,491,494,496,497','2'),
  (7, 'Eng Act 3', '488,487,480','2');
--

CREATE TABLE `assessment_questions` (
  `assessment_Id` int(11) NOT NULL,
  `question_id` int(11) NOT NULL,
  CONSTRAINT `FK_aq_questions` FOREIGN KEY (`question_id`) REFERENCES `questionbank` (`qId`),
  CONSTRAINT `FK_aq_assessments` FOREIGN KEY (`assessment_Id`) REFERENCES `assessments` (`assessment_Id`),
  PRIMARY KEY `Assessment_Question` (`assessment_Id`,`question_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `classes_taught_by_teacher` (
  `cttId` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `userId` int(11) NOT NULL,
  `classId` int(11) NOT NULL,
  `sectionId` int(11) NOT NULL,
  `subjectId` int(11) NOT NULL,
  UNIQUE `userId` (`userId`,`classId`,`sectionId`,`subjectId`),
  CONSTRAINT `FK_ctt_users` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`),
  CONSTRAINT `FK_ctt_classes` FOREIGN KEY (`classId`) REFERENCES `classes` (`classId`),
  CONSTRAINT `FK_ctt_sections` FOREIGN KEY (`sectionId`) REFERENCES `sections` (`sectionId`),
  CONSTRAINT `FK_ctt_subjects` FOREIGN KEY (`subjectId`) REFERENCES `subjects` (`subjectId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
--

INSERT INTO `classes_taught_by_teacher` (`cttId`, `userId`, `classId`, `sectionId`, `subjectId`) VALUES
  (48, 1, 1, 1, 1),
  (3, 1, 1, 1, 5),
  (4, 1, 1, 2, 5),
  (1, 1, 8, 3, 2),
...
CREATE TABLE `deploymentlog` (
  `depId` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  ...
  `deploySuccess` set('0','1','2') NOT NULL DEFAULT 0 ,
  CONSTRAINT UNIQUE `FK_dl_dedupe` (`assessmentId`,`depType`,`schStartDate`) ,
  CONSTRAINT `FK_dl_assessments` FOREIGN KEY (`assessmentId`) REFERENCES `assessments` (`assessment_Id`),
  CONSTRAINT `FK_dl_classes` FOREIGN KEY (`classId`) REFERENCES `classes` (`classId`),
  CONSTRAINT `FK_dl_sections` FOREIGN KEY (`sectionId`) REFERENCES `sections` (`sectionId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
--
...
INSERT INTO `deploymentlog` (`depId`, `depType`, `classId`, `sectionId`, `assessmentId`, `schStartDate`, `schEndDate`, `autoReminderDays`, `deploySuccess`) VALUES
  ...
  (2, 'A', 2, 6, 1, '2020-05-01', '2020-05-22', 0, 1),
  (3, 'A', 9, 2, 2, '2020-25-06', '2020-07-03', 0, 0),
  (4, 'A', 8, 4, 4, '2020-03-04', '2020-03-11', 0, 0),
  (5, 'T', 8, 1, 7, '2020-04-08', '2020-04-23', 0, 1),
  (6, 'T', 8, 2, 6, '2020-06-21', '2020-07-04', 0, 0),
  (7, 'T', 8, 4, 4, '2020-05-12', '2020-05-13', 0, 1),
  (8, 'T', 8, 3, 7, '2020-05-02', '2020-05-05', 0, 0),
  (9, 'Q', 2, 1, 3, '2020-04-01', '2020-05-01', 0, 1),
  (10, 'Q', 2, 2, 3, '2020-04-03', '2020-05-15', 0, 1),
  (11, 'Q', 2, 4, 3, '2020-05-13', '2020-06-15', 0, 1),
  (12, 'Q', 2, 6, 3, '2020-04-16', '2020-05-01', 0, 0),
  (13, 'Q', 8, 4, 5, '2020-06-21', '2020-06-27', 0, 0);
...
CREATE TABLE `questionbank` (
  ...
  `Option_5` varchar(50) ,
  `Option_6` varchar(50) ,
  CONSTRAINT `FK_qb_classes` FOREIGN KEY (`classId`) REFERENCES `classes` (`classId`),
  CONSTRAINT `FK_qb_subjects` FOREIGN KEY (`subjectId`) REFERENCES `subjects` (`subjectId`),
  CONSTRAINT `FK_qb_questionTypes` FOREIGN KEY (`typeId`) REFERENCES `questiontype` (`qtId`),
  CONSTRAINT `FK_qb_topics` FOREIGN KEY (`topicId`) REFERENCES `topics` (`topicId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
--
...
INSERT INTO `questionbank` (`qId`, `classId`, `subjectId`, `topicId`, `typeId`, `question`, `Option_1`, `Option_2`, `Option_3`, `Option_4`, `Option_5`, `Option_6`) VALUES
  ...
  (278, 8, 5, 8, 5, 'Why are rural women employed at very low wages?', '', '', '', '', '', ''),
  (279, 8, 5, 8, 5, 'When we refer to a woman as a \'resource\', we are referring to which of her skills?', '', '', '', '', '', ''),
  (280, 8, 5, 8, 5, 'Begging is which category of activity?', '', '', '', '', '', ''),
  (281, 8, 5, 8, 5, 'In which area of India is the literacy rate the lowest?', '', '', '', '', '', ''),
  ...
  (369, 8, 5, 8, 5, 'What are the major determinants of earnings?', '', '', '', '', '', ''),
  ...
  (378, 8, 5, 8, 5, 'Why literacy rate is high among the males of India?', '', '', '', '', '', ''),
...
CREATE TABLE `questiontype` (
  `qtId` smallint(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE `studentdetails` (
  ...
  `rollNumber` int(11) NOT NULL UNIQUE,
  `classId` int(11) DEFAULT NULL,
  `sectionId` int(11) DEFAULT NULL,
  UNIQUE `Roll_Number` (`rollNumber`,`classId`,`sectionId`),
  CONSTRAINT `FK_sd_classes` FOREIGN KEY (`classId`) REFERENCES `classes` (`classId`),
  CONSTRAINT `FK_sd_sections` FOREIGN KEY (`sectionId`) REFERENCES `sections` (`sectionId`),
  CONSTRAINT `FK_sd_users` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--

INSERT INTO `studentdetails` (`userId`, `rollNumber`, `classId`, `sectionId`) VALUES
  (9, 15, 8, 5),
  (10, 16, 9, 2),
  (11, 17, 1, 3),
  (12, 18, 9, 5),
...
CREATE TABLE `todolist` (
  ...
  CONSTRAINT `FK_tdl_users` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
--

INSERT INTO `todolist` (`todoId`, `userId`, `todoText`) VALUES
  (11, 2, 'Set test paper for Class VB'),
  (12, 1, 'Remind Class VI D about assignment');
...
CREATE TABLE `topics` (
  ...
  UNIQUE `classId` (`classId`,`subjectId`,`topicName`),
  CONSTRAINT `FK_tp_subjects` FOREIGN KEY (`subjectId`) REFERENCES `subjects` (`subjectId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`userId`, `role`, `firstName`, `middleName`, `lastName`, `Email`, `systemEmail`, `pw`, `joinYear`, `endYear`, `phoneMobile`, `visibility`) VALUES
  (1, 'T', 'Haradi', 'Keshav', 'Pai', 'hkeshavpai@gmail.com', 'HaradiKeshavPai@mydomain.com', 'asdf', '2000', '', '+919611907001', 'Y'),
  (2, 'T', 'Haradi', 'Aditya', 'Pai', 'adityapai@y7mail.com', 'HaradiAdityaPai@mydomain.com', 'ghjk', '2000', '', '+917619118922', 'Y'),
  (3, 'T', 'Haradi', 'Abhijit', 'Pai', 'apai1993@gmail.com', 'HaradiAbhijitPai@mydomain.com', 'abcd', '2000', '', '+919663304791', 'Y'),
  (4, 'T', 'Vinaya', 'Keshav', 'Pai', 'vinayakeshavpai@gmail.com', 'VinayaKeshavPai@mydomain.com', 'efgh', '2001', '', '+919663304792', 'Y'),
  (5, 'T', 'Kavya', 'Pai', 'T', 'kavyapai28@gmail.com', 'KavyaPaiT@mydomain.com', 'ijkl', '2003', '', '+916366856667', 'Y'),
  (6, 'T', 'Vasanta', 'Sudhakar', 'Rao', 'vinayapai@hotmail.com', 'VasantaSudhakarRao@mydomain.com', 'mnop', '2003', '', '+919611907001', 'Y'),
  (7, 'T', 'Anita', 'Sudhakar', 'Rao', 'vkaapai@yahoo.com', 'AnitaSudhakarRao@mydomain.com', 'qrst', '2002', '', '+919611907001', 'Y'),
  (8, 'T', 'Ganda', 'Wala', 'Teacher', 'gwt@asdf.com', 'GandaWalaTeacher@mydomain.com', 'uvwx', '', '', '9686084792', 'N'),
  (9, 'S', 'Aabhra', '', 'Acharya', 'AabhaAcharya@pxp.com', 'AabhaAcharya@mydomain.com', '7440502336', '2017', '', '7440502336', 'Y'),
  (10, 'S', 'Aabharan', '', 'Agarwal', 'AabharanAgarwal@mzb.com', 'AabharanAgarwal@mydomain.com', '6467471751', '2017', '', '6467471751', 'Y'),
  (11, 'S', 'Aabhas', '', 'Agate', 'AabhasAgate@wbu.com', 'AabhasAgate@mydomain.com', '2103988461', '2018', '', '2103988461', 'Y'),
  (12, 'S', 'Aabhadua', '', 'Aggarwal', 'AabhassAggarwal@jjz.com', 'AabhassAggarwal@mydomain.com', '1299381499', '2019', '', '1299381499', 'Y'),
  (13, 'S', 'Aabhavannan', '', 'Agrawal', 'AabhavannanAgrawal@teg.co', 'AabhavannanAgrawal@mydomain.com', '1233971509', '2014', '', '1233971509', 'Y'),
  (14, 'S', 'Aabheer', '', 'Ahluwalia', 'AabheerAhluwalia@ahx.com', 'AabheerAhluwalia@mydomain.com', '5740600229', '2019', '', '5740600229', 'Y'),
  (15, 'S', 'Aabher', '', 'Ahuja', 'AabherAhuja@czp.com', 'AabherAhuja@mydomain.com', '4829971174', '2018', '', '4829971174', 'Y'),
  (16, 'S', 'Aacharappan', '', 'Amble', 'AacharappanAmble@ltr.com', 'AacharappanAmble@mydomain.com', '2655320758', '2015', '', '2655320758', 'Y'),
  (17, 'S', 'Aacharya', '', 'Anand', 'AacharyaAnand@duj.com', 'AacharyaAnand@mydomain.com', '1201548763', '2018', '', '1201548763', 'Y'),
  (18, 'S', 'Aachman', '', 'Andra', 'AachmanAndra@xtt.com', 'AachmanAndra@mydomain.com', '5544423172', '2014', '', '5544423172', 'Y'),
  (19, 'S', 'Aachuthan', '', 'Anne', 'AachuthanAnne@pog.com', 'AachuthanAnne@mydomain.com', '2364020462', '2018', '', '2364020462', 'Y'),
  (20, 'S', 'Aadalarasan', '', 'Arora', 'AadalarasanArora@tnp.com', 'AadalarasanArora@mydomain.com', '4293462099', '2016', '', '4293462099', 'Y'),
  (21, 'S', 'Aadalarasu', '', 'Arya', 'AadalarasuArya@aqi.com', 'AadalarasuArya@mydomain.com', '1263296970', '2019', '', '1263296970', 'Y'),
  (22, 'S', 'Aad', '', 'Apte', 'AadApte@nmr.com', 'AadApte@mydomain.com', '2005948474', '2015', '', '2005948474', 'Y'),
  (23, 'S', 'Aadarsh', '', 'Atwal', 'AadarshAtwal@aix.com', 'AadarshAtwal@mydomain.com', '3642347592', '2016', '', '3642347592', 'Y'),
  (24, 'S', 'Aadavan', '', 'Aurora', 'AadavanAurora@awe.com', 'AadavanAurora@mydomain.com', '5300946917', '2019', '', '5300946917', 'Y'),
  (25, 'S', 'Aadavan', '', 'Babu', 'AadavanBabu@jsx.com', 'AadavanBabu@mydomain.com', '6833836173', '2014', '', '6833836173', 'Y'),
  (26, 'S', 'Aaddhar', '', 'Badal', 'AaddharBadal@sua.com', 'AaddharBadal@mydomain.com', '2355862007', '2015', '', '2355862007', 'Y'),
  (27, 'S', 'Aadeep', '', 'Badami', 'AadeepBadami@rnf.com', 'AadeepBadami@mydomain.com', '6967636528', '2019', '', '6967636528', 'Y'),
  (28, 'S', 'Aadesh', '', 'Bahl', 'AadeshBahl@eey.com', 'AadeshBahl@mydomain.com', '3212828130', '2014', '', '3212828130', 'Y'),
  (29, 'S', 'Aadeshwar', '', 'Bahri', 'AadeshwarBahri@vqx.com', 'AadeshwarBahri@mydomain.com', '2870840118', '2017', '', '2870840118', 'Y'),
  (30, 'S', 'Aadhan', '', 'Bail', 'AadhanBail@irt.com', 'AadhanBail@mydomain.com', '9873231318', '2014', '', '9873231318', 'Y'),
  (31, 'S', 'Abhju', '', 'Soja', 'apai193@yahoo.co.in', 'AbhjuSoja@mydomain.com', '', '0000-00-00', '0000-00-00', '9196633047', 'Y'),
  (32, 'S', 'Vijay', '', 'Vijuma', 'vivijuma@yahoo.com', 'VijayVijuma@mydomain.com', '', '0000-00-00', '0000-00-00', '9663304791', 'Y'),
  (33, 'S', 'Aditya', '', 'Pai', 'adityapai@y7mail.com', 'AdityaPaimydomain.com', '', '0000-00-00', '0000-00-00', '9663304792', 'Y'),
  (34, 'S', 'Chor', 'Bhajia', '', 'cbha@vkpsolutions.com', 'ChorBhajia@mydomain.com', '', '0000-00-00', '0000-00-00', '3322556688', 'Y'),
  (35, 'S', 'Daamodar', '', 'Bains', 'DaamodarBains@ciy.com', 'DaamodarBains@mydomain.com', '6697460354', '2016', '', '6697460354', 'Y'),
  (36, 'S', 'Daarshik', '', 'Bajaj', 'DaarshikBajaj@zif.com', 'DaarshikBajaj@mydomain.com', '6252028601', '2019', '', '6252028601', 'Y'),
  (37, 'S', 'Daaruk', '', 'Bajwa', 'DaarukBajwa@kia.com', 'DaarukBajwa@mydomain.com', '9599498968', '2017', '', '9599498968', 'Y'),
  (38, 'S', 'Daarun', '', 'Bakshi', 'DaarunBakshi@sst.com', 'DaarunBakshi@mydomain.com', '1759930847', '2014', '', '1759930847', 'Y'),
  (39, 'S', 'Daasu', '', 'Bal', 'DaasuBal@idq.com', 'DaasuBal@mydomain.com', '5564801148', '2015', '', '5564801148', 'Y'),
  (40, 'S', 'Dabang', '', 'Bala', 'DabangBala@wqj.com', 'DabangBala@mydomain.com', '7816307738', '2015', '', '7816307738', 'Y'),
  (41, 'S', 'Dabeet', '', 'Bala', 'DabeetBala@qzu.com', 'DabeetBala@mydomain.com', '5632918737', '2016', '', '5632918737', 'Y'),
  (42, 'S', 'Dabhiti', '', 'Balakrishnan', 'DabhitiBalakrishnan@cpv.c', 'DabhitiBalakrishnan@mydomain.com', '3415180208', '2015', '', '3415180208', 'Y'),
  (43, 'S', 'Dabnshu', '', 'Balan', 'DabnshuBalan@kfz.com', 'DabnshuBalan@mydomain.com', '5281612819', '2017', '', '5281612819', 'Y'),
  (44, 'S', 'Dadasaheb', '', 'Balasubramanian', 'DadasahebBalasubramanian@', 'DadasahebBalasubramanian@mydomain.com', '9396067830', '2019', '', '9396067830', 'Y'),
  (45, 'S', 'Dadhica', '', 'Balay', 'DadhicaBalay@vmc.com', 'DadhicaBalay@mydomain.com', '2211072885', '2016', '', '2211072885', 'Y'),
  (46, 'S', 'Droopy', '', 'Stuppi', 'dstu@vkpsolutions.com', 'DroopiStuppi@mydomain.com', '', '0000-00-00', '0000-00-00', '15995611590', 'Y'),
  (47, 'S', 'Falor', '', 'Sofa', 'fsof@vkpsolutions.com', 'FalorSofa@mydomain.com', '', '0000-00-00', '0000-00-00', '1424344454', 'Y'),
  (48, 'S', 'fikk', '', 'Sicck', 'fs@fds.com', 'fikkSicck@mydomain.com', '', '0000-00-00', '0000-00-00', '1591591590', 'Y'),
  (49, 'S', 'Piddi', '', 'Koota', 'pikoo@vkpsolutions.com', 'PiddiKoota@mydomain.com', '', '', '', '9966338855', 'Y'),
  (50, 'S', 'Joori', '', 'Poori', 'jooripoori@asd.com', 'JooriPoori@mydomain.com', '', '2018', '2021', '1234567890', 'Y'),
  (51, 'S', 'Roja', 'dul', 'Paitu', 'vkaapai@yahoo.com', 'RojadulPaitu@mydomain.com', '', '0000-00-00', '0000-00-00', '9611907001', 'Y'),
  (52, 'S', 'Pramod', '', 'Dumbo', 'pdum@vkpsolutions.com', 'PramodDumbo@mydomain.com', '', '0000-00-00', '0000-00-00', '3652365201', 'Y'),
  (53, 'S', 'Vartha', '', 'Manishu', 'vman@vkpsolutions.com', 'VarthaManishu@mydomain.com', '', '0000-00-00', '0000-00-00', '6454342421', 'Y'),
  (54, 'S', 'Faltu', '', 'Baltu', 'falbal@wewe.com', 'FaltuBaltu@mydomain.com', '', '2017', '2022', '8787878787', 'Y'),
  (55, 'S', 'Ganju', '', 'Panju', 'ganpan@vkpsolutions.com', 'GanjuPanju@mydomain.com', '', '', '', '4564564560', 'Y'),
  (56, 'S', 'Priti', NULL, 'Ganguli', 'pgg@myhsdf.com', 'PritiGanguli@mydomain.com', '', '2020', '', '1252345600', ''),
  (57, 'S', 'Anuja', NULL, 'Sujan', 'asd@fdsa.com', 'AnujaSujan@mydomain.com', '', '2020', '', '9099099099', ''),
  (58, 'S', 'Dhuri', NULL, 'Ghuri', 'dfras@sdsd.com', 'DhuriGhuri@mydomain.com', '', '2020', '', '8978675645', ''),
  (59, 'S', 'Momo', NULL, 'Jojo', 'mjmj@dsf.com', 'MomoJojo@mydomain.com', '9494949494', '2020', '', '9494949494', ''),
  (60, 'S', 'Gobi', NULL, 'Jojo', 'gbj@dsf.com', 'GobiJojo@mydomain.com', '9494949490', '2020', '', '9494949490', ''),
  (61, 'S', 'Tydim', NULL, 'Duredi', 'tad@fgv.com', 'TydimDuredi@mydomain.com', '6767675438', '2020', '', '6767675438', ''),
  (62, 'S', 'Tydim', NULL, 'Guj', 'tag@fgv.com', 'TydimGuj@mydomain.com', '6767675477', '2020', '', '6767675477', ''),
  (63, 'S', 'Ighu', NULL, 'Guhuh', 'igu@wers.com', 'IghuGuhuh@mydomain.com', '8456120345', '2020', '', '8456120345', ''),
  (64, 'S', 'Ighu', NULL, 'Hughug', 'iguhf@wers.com', 'IghuHughug@mydomain.com', '8456120340', '2020', '', '8456120340', ''),
  (65, 'S', 'zxcfd', NULL, 'cvbdsf', 'zxc@vbn.com', 'zxcfdcvbdsf@mydomain.com', '3265948752', '2020', '', '3265948752', ''),
  (66, 'S', 'zxc', NULL, 'cvb', 'zxc@vbn.com', 'zxccvb@mydomain.com', '3265948754', '2020', '', '3265948754', ''),
  (67, 'S', 'ded', NULL, 'cd', 'reft@dsd.com', 'dedcd@mydomain.com', '4353434231', '2020', '', '4353434231', ''),
  (68, 'S', 'frg', NULL, 'ghj', 'cdfv@mnm.com', 'frgghj@mydomain.com', '7894563451', '2020', '', '7894563451', ''),
  (69, 'S', 'rewte', NULL, 'desa', 'dfrwad@.zxcv.com', 'rewtedesa@mydomain.com', '1425363738', '2020', '', '1425363738', ''),
  (70, 'S', 'MMM', 'as', 'dase', 'wewe@egvrg.com', 'MMMasdase@mywebsite.com', '12121212', NULL, NULL, '12121212', 'Y');
