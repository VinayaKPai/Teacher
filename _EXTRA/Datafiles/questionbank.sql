...
CREATE TABLE `questionbank` (
  ...
  `Option 1` varchar(50) NOT NULL,
  `Option 2` varchar(50) NOT NULL,
  `Option 3` varchar(50) NOT NULL,
  `Option 4` varchar(50) NOT NULL,
  `Option 5` varchar(50) NOT NULL,
  `Option 6` varchar(50) NOT NULL
...
(192, '9', '5', '8', '4', 'What does \'People as a Resource\' mean?', '', '', '', '', '', ''),
...
(233, '9', '5', '8', '4', 'How unemployment has detrimental impact on the overall growth of economy?', '', '', '', '', '', ''),
...
(438, '1', '2', '9', '2', '1) Direction: Identity the odd one out of the four choices given below in each question:', 'Green', 'Red', 'Colour', 'Orange', 'None of these', ''),
(439, '1', '2', '9', '2', '2) Direction: Identity the odd one out of the four choices given below in each question:', 'Venus', 'Mars', 'Pluto', 'Neptune', 'None of these', ''),
(440, '1', '2', '9', '2', '3) Direction: Identity the odd one out of the four choices given below in each question:', 'Happy', 'Gloomy', 'Lively', 'Cheerful', 'None of these', ''),
(441, '1', '2', '9', '2', '4) Direction: Identity the odd one out of the four choices given below in each question:', 'Cub', 'Chicken', 'Pig', 'Pup', 'None of these', ''),
(442, '1', '2', '9', '2', '5) Direction: Identity the odd one out of the four choices given below in each question:', 'Knee', 'Foot', 'Ankle', 'Palm', 'None of these', ''),
(443, '1', '2', '9', '2', '6) Direction: Identity the odd one out of the four choices given below in each question:', 'Immortal', 'Eminent', 'Perpetual', 'Everlasting', 'None of these', ''),
(444, '1', '2', '9', '2', '7) Direction: Identity the odd one out of the four choices given below in each question:', 'Mathematics', 'Algebra', 'Trigonometry', 'Geometry', 'None of these', ''),
(445, '1', '2', '9', '2', '8) Direction: Identity the odd one out of the four choices given below in each question:', 'Adore', 'Like', 'Love', 'Laugh', 'None of these', ''),
(446, '1', '2', '9', '2', '9) Direction: Identity the odd one out of the four choices given below in each question:', 'Club', 'Heart', 'Spade', 'Ace', 'None of these', ''),
(447, '1', '2', '9', '2', '10) Direction: Identity the odd one out of the four choices given below in each question:', 'Dismay', 'Dread', 'Downer', 'Delight', 'None of these', ''),
(448, '1', '2', '9', '2', '11) Direction: Identity the odd one out of the four choices given below in each question:', 'Rose', 'Pink', 'Red', 'Maroon', 'None of these', ''),
(449, '1', '2', '9', '2', '12) Direction: Identity the odd one out of the four choices given below in each question:', 'Mature', 'Youthful', 'Ripen', 'Mellow', 'None of these', ''),
(450, '1', '2', '9', '2', '13) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Claver', 'Wise', 'Doubly', 'Foolish', 'None of these', ''),
(451, '1', '2', '9', '2', '14) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Sword', 'Spear', 'Shield', 'Arrow', 'None of these', ''),
(452, '1', '2', '9', '2', '15) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'What', 'Which', 'Who', 'Whoever', 'None of these', ''),
(453, '1', '2', '9', '2', '16) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Witch', 'Hind', 'Ewe', 'Stag', 'None of these', ''),
(454, '1', '2', '9', '2', '17) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Best', 'Upper', 'Worst', 'Least', 'None of these', ''),
(455, '1', '2', '9', '2', '18) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Have', 'Do', 'Can', 'Am', 'None of these', ''),
(456, '1', '2', '9', '2', '19) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'In', 'Or', 'Of', 'Off', 'None of these', ''),
(457, '1', '2', '9', '2', '20) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'But', 'Still', 'Only', 'Else', 'None of these', ''),
(458, '1', '2', '9', '2', '21) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Nest', 'Shed', 'Stable', 'Kennel', 'None of these', ''),
(459, '1', '2', '9', '2', '22) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Sad', 'Cheerful', 'Jovial', 'Festive', 'None of these', ''),
(460, '1', '2', '9', '2', '23) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Helicopter', 'Steamer', 'Chariot', 'Automobile', 'None of these', ''),
(461, '1', '2', '9', '2', '24) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Long jump', 'Athletics', 'High jump', 'Running', 'None of these', ''),
(462, '1', '2', '9', '2', '25) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'English', 'Biology', 'Mathematics', 'Physics', 'None of these', ''),
(463, '1', '2', '9', '2', '26) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Magazine', 'Novel', 'Book', 'Dictionary', 'None of these', ''),
(464, '1', '2', '9', '2', '27) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Day', 'Week', 'Fortnight', 'Calendar', 'None of these', ''),
(465, '1', '2', '9', '2', '28) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Plumber', 'Tailor', 'Sailor', 'Carpenter', 'None of these', ''),
(466, '1', '2', '9', '2', '29) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Square', 'Area', 'Triangle', 'Circle', 'None of these', ''),
(467, '1', '2', '9', '2', '30) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Paper', 'Foot ruler', 'Sharpener', 'Teacher', 'None of these', ''),
(468, '1', '2', '9', '2', '31) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Bench', 'Sofa', 'Cupboard', 'Chair', 'None of these', ''),
(469, '1', '2', '9', '2', '32) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Chisel', 'Tools', 'Hammer', 'Axe', 'None of these', ''),
(470, '1', '2', '9', '2', '33) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Tree', 'Root', 'Flower', 'Leaf', 'None of these', ''),
(471, '1', '2', '9', '2', '34) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Climber', 'Plant', 'Shrub', 'Creeper', 'None of these', ''),
(472, '1', '2', '9', '2', '35) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Calcutta', 'Chennai', 'Bengaluru', 'Mumbai', 'None of these', ''),
(473, '1', '2', '9', '2', '36) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Hut', 'Bungalow', 'Cottage', 'Apartments', 'None of these', ''),
(474, '1', '2', '9', '2', '37) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Guava', 'Cauliflower', 'Malta', 'Coconut', 'None of these', ''),
(475, '1', '2', '9', '2', '38) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Gallon', 'Ton', 'Quintal', 'Kilogram', 'None of these', ''),
(476, '1', '2', '9', '2', '39) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Opening', 'Yawn', 'Junction', 'Cleft', 'None of these', ''),
(477, '1', '2', '9', '2', '40) Direction: Each of the following questions is followed by four alternatives out of which one is different from the rest three. This alternative is your answer.', 'Snooker', 'Badminton', 'Squash', 'Volleyball', 'None of these', ''),
(478, '', '', '', '', '', '', '', '', '', '', ''),
(479, '', '', '', '', '', '', '', '', '', '', ''),
(480, '', '', '', '', '', '', '', '', '', '', ''),
(481, '', '', '', '', '', '', '', '', '', '', ''),
...
--
ALTER TABLE `questionbank`
  MODIFY `Id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=541;
COMMIT;
