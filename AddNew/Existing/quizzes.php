...
<table id="existTable" style="width: 100%; padding: 5px; border-spacing: 2px; border-collapse: separate; align: 'center';">
	...
	$query = $mysqli->query("SELECT * FROM assessments, classes, subjects WHERE  `assessment_Type` = 'Q' AND classes.classId = assessments.assessment_classId AND subjects.subjectId = assessments.assessment_subjectId ORDER BY classes.classId, subjects.subjectId");
          ...
          echo "No assessments";
				...
				echo "<h4 class='topbanner'>Currently $rowcount Quizzes in your setup.</h4>" ;

				if ($rowcount > 0) {
          echo "<tr><th>SNo</th><th>Title</th><th>Class/STD</th><th>Subject</th><th>Questions</th></tr>";
