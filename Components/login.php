  ...
  <div class="col-sm-6 jumbotron small"  style="margin: 10% 25%;  width: 50%; padding: 2% 2%; border-radius: 5px">
        <span>OR</span>
          <button type="button" class="button btn-secondary btn-small" style="">
            ...
            <span class="btn_text_wrap text-16">Continue with Google</span>
          </button>
          <button type="button" class="button btn-secondary btn-fb">
            Continue with Facebook
          </button>
      <div class="row">
        <p class="text-foot">
          <span>&nbsp;or&nbsp;</span>
          <a href="../../Components/login_with_email.php">use your email</a>
        </p>
      </div>
    </div>
</div>
