...
//called in Scripts/php/allRetrievalQueries
//called by classesTaughtByTeachers
//
function cttQueryResultToHtmlTable( $result ) {
  ...
  if ($result) {
    ...
    echo "<h3 class='topbanner centered'>$rowcount Subjects assigned to Teachers in your setup</h3>" ;
