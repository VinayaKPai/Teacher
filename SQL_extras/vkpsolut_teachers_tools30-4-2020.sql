...
CREATE TABLE `assessments` (
  `assessment_Id` int(11) NOT NULL PRIMARY KEY,
...
CREATE TABLE `classes` (
  `classId` int(11) NOT NULL PRIMARY KEY,
...
CREATE TABLE `classes_taught_by_teacher` (
  `cttId` int(11) NOT NULL PRIMARY KEY,
...
CREATE TABLE `deploymentlog` (
  `depId` int(11) NOT NULL PRIMARY KEY COMMENT 'Auto generated unique id for the deployment',
...
CREATE TABLE `questiontype` (
  `qtId` smallint(11) NOT NULL PRIMARY KEY,
...
CREATE TABLE `sections` (
  `sectionId` int(11) NOT NULL PRIMARY KEY,
...
CREATE TABLE `subjects` (
  `subjectId` int(11) NOT NULL PRIMARY KEY,
...
CREATE TABLE `todolist` (
  `todoId` int(11) NOT NULL PRIMARY KEY,
...
CREATE TABLE `topics` (
  `topicId` int(11) NOT NULL PRIMARY KEY,
  `classId` varchar(4) NOT NULL,
