...
<body class="body" style="background: var(--BodyGradient); height: 100%;">
	<div class="container">
	 ...
	 <div style="background: var(--BodGradbanner);">
		 	...
		 	<div class="panel-group" id="accordion">
				<h5 class='centered topbanner'>Ongoing Assignments</h5>
		 		<?php
					$status = "ongoing";
					$successFlag = 1;
	 			 include $_SERVER['DOCUMENT_ROOT']."/Components/activityBody.php";
			...
			<div class="panel-group" id="accordion">
				<h5 class='centered topbanner'>Undeployed Assignments</h5>
		 		<?php
					$status = "undeployed";
					$successFlag = 0;
	 			 include $_SERVER['DOCUMENT_ROOT']."/Components/activityBody.php";
		 	...
		 	<div class="panel-group" id="accordion">
				<h5 class='centered topbanner'>Withdrawn Assignments</h5>
		 		<?php
					$status = "withdrawn";
					$successFlag = 2;
		 		 include $_SERVER['DOCUMENT_ROOT']."/Components/activityBody.php";
